...
$query = "INSERT INTO rekam_medis(pasien_id,dokter_id,ruang_id,keluhan,diagnosa,tanggal,created_at,created_by) VALUES('$pasien_id', '$dokter_id',  '$ruang_id', '$keluhan', '$diagnosa', '$tanggal', '$created_at','$created_by')";
if (create($query) === 1) {
